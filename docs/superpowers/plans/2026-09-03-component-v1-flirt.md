...
- [x] **Step 4: Verify GREEN and existing F5/F6 regressions**
...
- [x] **Step 3: Add the minimal in-memory alias**
...
- [x] **Step 4: Verify GREEN and golden stability**
...
- [x] **Step 3: Make direct baseline extraction complete**
...
- [x] **Step 3: Add the smallest wiring change**
...
- [x] **Step 1: Write synthetic evaluation tests**
...
- [x] **Step 3: Implement the evaluation-only scorer**
...
- [x] **Step 4: Verify GREEN and the oracle firewall**
...
- [x] **Step 1: Preflight without oracle**

Check the binary hash and every run-stage/candidate hash. Convert only
Oxidizer `direct-flirt` matches. Join and derive member IDs from `address`,
while preserving `mapped_address` only as evidence; never use wrapper or
cleanup results as seeds.

- [x] **Step 2: Generate and hash predictions before scoring**
...
- [x] **Step 3: Open the oracle only in the evaluator**
...
- [x] **Step 4: Write the temporary Inbox note**
